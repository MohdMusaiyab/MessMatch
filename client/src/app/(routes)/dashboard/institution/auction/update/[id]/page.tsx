...
const AuctionDetail = () => {
  ...
  const isCreator = session?.user.id === auction.creatorId; // Assuming auction has a creatorId field
  ...
  return (
    <div className="container mx-auto p-4">
      ...
      {/* Conditionally render the update form if the user is the creator */}
      {isCreator && (
